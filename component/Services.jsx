...
const Services = () => {
    ...
    return (
        <div className="w-11/12 mx-auto grid grid-cols-12 pb-16 text-white">
            <div className="lg:col-span-6 md:col-span-6 col-span-12 lg:px-6 md:px-2 px-0 mb-16">
                <h1 className="lg:text-5xl md:text-5xl text-4xl text-white gill-sans"><i className="ri-award-fill text-[#052740]"></i> My Experience</h1>
                ...
                <div className="flex flex-col gap-6 my-8">
                    <div className="bg-[#06131B] shadow-xl rounded-xl p-6 w-full container-gradient">
                        ...
                        <h1 className="text-semibold lg:text-4xl md:text-3xl text-2xl text-white gill-sans ml-8 my-4">SENIOR DEVELOPER</h1>
                    ...
                    <div className="bg-[#06131B] shadow-xl rounded-xl p-6 w-full container-gradient">
                        ...
                        <h1 className="text-semibold lg:text-4xl md:text-3xl text-2xl text-white gill-sans ml-8 my-4">WEB DEVLOPER</h1>
                    ...
                    <div className="bg-[#06131B] shadow-xl rounded-xl p-6 w-full container-gradient">
                        ...
                        <h1 className="text-semibold lg:text-4xl md:text-3xl text-2xl text-white gill-sans ml-8 my-4">UI DESIGNER</h1>
                    ...
                    <div className="bg-[#06131B] shadow-xl rounded-xl p-6 w-full container-gradient">
                        ...
                        <h1 className="text-semibold lg:text-4xl md:text-3xl text-2xl text-white gill-sans ml-8 my-4">INTERN UI/UX DESIGNER</h1>
            ...
            <div className="lg:col-span-6 md:col-span-6 col-span-12 lg:px-6 md:px-2 px-0">
                <h1 className="lg:text-5xl md:text-5xl text-4xl text-white gill-sans"><i className="ri-graduation-cap-fill text-[#052740]"></i> My Education</h1>

                <div className="flex flex-col gap-6 my-8">
                    <div className="bg-[#06131B] shadow-xl rounded-xl p-6 w-full container-gradient">
                        <h1 className="text-2xl font-semibold text-[#13A2FD] gill-sans"><i className="ri-record-circle-fill text-lg mr-3"></i> 2022 - 2023</h1>
                        <h1 className="text-semibold lg:text-4xl md:text-3xl text-2xl text-white gill-sans ml-8 my-4">PROGRAMING COURSE</h1>
                    ...
                    <div className="bg-[#06131B] shadow-xl rounded-xl p-6 w-full container-gradient">
                        ...
                        <h1 className="text-semibold lg:text-4xl md:text-3xl text-2xl text-white gill-sans ml-8 my-4">GRAPHIC DESING COURSE</h1>
                    ...
                    <div className="bg-[#06131B] shadow-xl rounded-xl p-6 w-full container-gradient">
                        ...
                        <h1 className="text-semibold lg:text-4xl md:text-3xl text-2xl text-white gill-sans ml-8 my-4">WEB DESING COURSE</h1>
                    ...
                    <div className="bg-[#06131B] shadow-xl rounded-xl p-6 w-full container-gradient">
                        ...
                        <h1 className="text-semibold lg:text-4xl md:text-3xl text-2xl text-white gill-sans ml-8 my-4">DESIGN & TECHNOLOGY</h1>
